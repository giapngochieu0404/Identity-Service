...
public class CanPermissionAspect {
  ...
  public void checkPermission(CanPer canPer) {
    ...
    if (permissionName != null) {
      ...
      if (userInfo == null || userInfo.getId() == null || Boolean.FALSE.equals(checkPermission(userInfo.getId(), permissionName))) {
        throw new CanPermissionException(message);
      }
    }
  }

  private String mapAttribute(String message, String attribute) {return message.replace("{name}", attribute);
  }
